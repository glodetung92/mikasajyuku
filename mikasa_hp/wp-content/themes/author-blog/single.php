						...
						if ( true === $post_navigation_show ) :
							...
							<div class="d-flex single-post-navigation justify-content-between">
								<div class="previous-post">
									<div class="postarrow"><i class="fa fa-long-arrow-left"></i><?php echo esc_html_e( 'Previous Post', 'author-blog' ); ?></div>
									<?php echo wp_kses_post( get_previous_post_link( '%link' ) ); ?>
								</div>
								<div class="next-post">
									<div class="postarrow"><?php echo esc_html_e( 'Next Post', 'author-blog' ); ?><i class="fa fa-long-arrow-right"></i></div>
