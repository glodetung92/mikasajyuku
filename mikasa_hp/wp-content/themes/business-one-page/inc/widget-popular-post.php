...
function business_one_page_register_popular_post_widget() {
    register_widget( 'Business_One_Page_Popular_Post' );
}
add_action( 'widgets_init', 'business_one_page_register_popular_post_widget' );
 
 /**
 * Adds Business_One_Page_Popular_Post widget.
 */
class Business_One_Page_Popular_Post extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'business_one_page_popular_post', // Base ID
			__( 'RARA: Popular Post', 'business-one-page' ), // Name
			array( 'description' => __( 'A Popular Post Widget', 'business-one-page' ), ) // Args
		);
	}
	...
	public function widget( $args, $instance ) {
        ...
        $title      = ! empty( $instance['title'] ) ? sanitize_text_field( $instance['title'] ) : __( 'Popular Posts', 'business-one-page' );
	...
	public function update( $new_instance, $old_instance ) {
        ...
        $instance['title']          = ! empty( $new_instance['title'] ) ? sanitize_text_field( $new_instance['title'] ) : __( 'Popular Posts', 'business-one-page' );
...
} // class Business_One_Page_Popular_Post 