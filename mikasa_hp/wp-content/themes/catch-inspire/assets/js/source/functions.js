...
( function( $ ) {
    ...
    $( function() {
        $( document ).ready( function() {
            $('.featured-content-wrapper .entry-container, .portfolio-content-wrapper .hentry-inner, .service-content-wrapper .hentry-inner, .team-content-wrapper .hentry-inner, .numbers-content-wrapper .hentry').matchHeight();
        });
    });
    ...
    ( function() {
        ...
        menuToggle.on( 'click.catchInspire', function() {
    ...
    ( function() {
        ...
        function toggleFocusClassTouchScreen() {
            if ( window.innerWidth >= 1024 ) {
                $( document.body ).on( 'touchstart.catchInspire', function( e ) {
                    if ( ! $( e.target ).closest( '.main-navigation li' ).length ) {
                        $( '.main-navigation li' ).removeClass( 'focus' );
                    }
                } );
                siteNavigation.find( '.menu-item-has-children > a' ).on( 'touchstart.catchInspire', function( e ) {
                ...
                siteNavigation.find( '.menu-item-has-children > a' ).unbind( 'touchstart.catchInspire' );
            }
        }

        if ( 'ontouchstart' in window ) {
            $( window ).on( 'resize.catchInspire', toggleFocusClassTouchScreen );
            toggleFocusClassTouchScreen();
        }

        siteNavigation.find( 'a' ).on( 'focus.catchInspire blur.catchInspire', function() {
    ...
    //Mobile Toggle Top
    $( '#mobile-toggle-top' ).on( 'click', function() {
