...
function education_zone_scripts() {
	...
	wp_enqueue_script( 'modal-accessibility', get_template_directory_uri() . '/js' . $build . '/modal-accessibility' . $suffix . '.js', array('jquery'), EDUCATION_ZONE_THEME_VERSION, true );
