...
if( ! function_exists( 'education_zone_site_branding' ) ):
    /**
     * Callback for Social Links
    */
    function education_zone_site_branding(){
        ?>
            ...
            <div class="mobile-menu">
                <nav id="mobile-site-navigation" class="main-navigation mobile-navigation">
                    <div class="primary-menu-list main-menu-modal cover-modal" data-modal-target-string=".main-menu-modal">
                        ...
                        <?php get_search_form(); ?> 
                        <div class="mobile-menu-title" aria-label="<?php esc_attr_e( 'Mobile', 'education-zone' ); ?>">
                            <?php
                                wp_nav_menu( array(
                        ...
                        <?php if( has_nav_menu( 'secondary' ) ){ 
                            wp_nav_menu( array( 'theme_location' => 'secondary', 'container' => false, 'menu_id' => 'mobile-secondary-menu', 'fallback_cb' => false ) );
                        } 
...
function education_zone_site_header(){
    ...
    <header id="masthead" class="site-header" role="banner" itemscope itemtype="https://schema.org/WPHeader">
            ...
            <div class="header-m">
                <div class="container">
                    <?php education_zone_site_branding(); ?>
...
if( ! function_exists( 'education_zone_get_sections' ) ) :
    /**
...
if ( ! function_exists( 'education_zone_footer_bottom' ) ) :
