<?php 
	$fabify_hs_slider= get_theme_mod('hide_show_slider','on');
	if( $fabify_hs_slider == 'on' ): 
?>
...
<?php if(!empty($id_arr))
{ ?>
	<section id="slider-section" class="slider-wrapper slider-section-six">
		<div class="main-slider arrows-small arrows-transparent">
			...
			<div class="item">
				...
				<div class="specia-slider <?php echo get_post_meta( get_the_ID(),'slider_caption_align', true); ?>" style="background: rgba(0,0,0,0.3);">
                            ...
                            <div class="container">                                
                                <div class="specia-content">
									...
									<?php if( get_post_meta(get_the_ID(),'slidebutton', true ) ): ?>
										<a data-animation="fadeInUp" data-delay="850ms" href="<?php echo esc_url( get_post_meta( get_the_ID(),'slidebuttonlink', true) ); ?>" class="bt-primary specia-btn-1"><?php echo esc_html( get_post_meta( get_the_ID(),'slidebutton', true) ); ?></a>
									<?php endif; ?>
								</div>
							</div>
						</div>
